...
public class BlackListDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		String sql = "CREATE TABLE "
				...
				+ "name TEXT NOT NULL, mobile TEXT NOT NULL, type INTEGER NOT NULL, block INTEGER NOT NULL,address TEXT)";
		
		Logger.i(TAG, "create black_list");
		db.execSQL(sql);
	...
	public long insert(String name, String mobile,int type,String address) {
		if (mobile == null) {
			return -1;
		...
		contentValues.put("block", Decider.ACTION_CALL_BLOCK_END);
			...
			while (c.moveToNext()) {
				...
				if(str.equals(null)||str.equals("")){
				 ...
				 strs = DisplayCallService.getInCommingNUm(num);
					 ...
					 str=strs;
					 db.execSQL("update black_list set address="+"'"+str+"'"+" where mobile="+"'"+get2+"'");
