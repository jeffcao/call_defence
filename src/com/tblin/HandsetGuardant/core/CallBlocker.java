...
import com.tblin.HandsetGuardant.CallEnder;
import com.tblin.HandsetGuardant.CallHandler;
import com.tblin.HandsetGuardant.ContactInformationGetter;
...
public class CallBlocker implements Blocker {
	...
	public void block(Map<String, Object> data) {
		...
		mAudioManager.setRingerMode(AudioManager.RINGER_MODE_SILENT);
				...
				case Decider.ACTION_CALL_BLOCK_SILENCE:
					...
					break;
				case Decider.ACTION_CALL_BLOCK_END:
					endCall(context, phone);
					mAudioManager.setRingerMode(origin);
					break;
				case Decider.ACTION_WHITE_DEFULAT_BLOCK_TYPE:
					endCall(context, phone);
					mAudioManager.setRingerMode(origin);
					break;
				default:
