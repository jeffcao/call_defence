...
public class BlockListDBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		String sql = "CREATE TABLE "
				...
				+ "name TEXT NOT NULL, mobile TEXT NOT NULL, time LONG NOT NULL )";
		String sms= "CREATE TABLE "
				+ TABLE_SMS
				+ "(_id INTEGER DEFAULT '1' NOT NULL PRIMARY KEY AUTOINCREMENT,"
				+ "name TEXT NOT NULL, mobile TEXT NOT NULL, time LONG NOT NULL,content TEXT  )";
		db.execSQL(sql);
		db.execSQL(sms);
	...
	public long insert(String name, String mobile, long time) {
	...
	public long insertCall(String name, String mobile, long time) {
		if (name == null || mobile == null || time == -1) {
			return -1;
		}
		SQLiteDatabase db = getWritableDatabase();
	...
	public long insertSMS(String name, String mobile, long time,String content) {
		if (name == null || mobile == null || time == -1 ) {
			return -1;
		}
		SQLiteDatabase db = getWritableDatabase();
...
//	public List<BlockEvent> getAllRecords() {
//		List<BlockEvent> events = new ArrayList<BlockEvent>();
//		SQLiteDatabase db = getReadableDatabase();
